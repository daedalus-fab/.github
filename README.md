# daedalus-fab organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`daedalus-fab`](https://github.com/daedalus-fab).

## Canonical organization links

- GitHub organization: https://github.com/daedalus-fab
- Public organization defaults: https://github.com/daedalus-fab/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomdaedalus-fab-6d311a6d8d19
...
`daedalus-fab` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
